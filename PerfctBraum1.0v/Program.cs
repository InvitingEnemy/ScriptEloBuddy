...
namespace Braum
{
    static class Program
    {
        ...
        {
            if (Player.BaseSkinName != CN) { Chat.Print("Warning Some Bugs have occurred with Darw R and W So they will be Divided:  " + CN + ", addon disabled please retry"); return; }
            ...
            Menu = MainMenu.AddMenu("Braum", "Braum");
            ...
            Auto = Menu.AddSubMenu("Auto Harass");
            ...
            Update.AddLabel("V1.2 Updated");
            Update.AddLabel("- Cast W Fixed");
            Update.AddLabel("- Cast R Prediction to all Enemies");
            Update.AddLabel("- Cast E Partially Fixed(I'm still working on it)");
            Update.AddLabel("- Cast Bugs");
            Update.AddLabel("- Warning Some Bugs have occurred with Darw R and W So they will be Divided");
            ...
            Chat.Print("Braum is here " + CN + " Loaded");
